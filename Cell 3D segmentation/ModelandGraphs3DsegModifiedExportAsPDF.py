...
s20minpath = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\3D segmentation on Virtual Machine\Reversible Stimulation Tests\20mindata'
...
graphpath = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\3D segmentation on Virtual Machine\Reversible Stimulation Tests\finalgraphs\for figures\'
...
C450Vpath = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\3D segmentation on Virtual Machine\Reversible Stimulation Tests\c450vdata'
stimendC450V = 150
...
row = 0
col = 0
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, apical2hstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames2h, apical2hstimls[1], apical2hstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames2h, apical2hnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
axes[row, col].fill_between(frames2h, apical2hnonstimls[1], apical2hnonstimls[2], color='#4f81c2', alpha=.1)
axes[row, col].legend(loc = "lower right", fontsize = 7)
...
col = 1
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, basal2hstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames2h, basal2hstimls[1], basal2hstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames2h, basal2hnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
...
col = 0
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, length2hstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames2h, length2hstimls[1], length2hstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames2h, length2hnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
...
col = 1
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, vol2hstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames2h, vol2hstimls[1], vol2hstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames2h, vol2hnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
...
plt.subplots_adjust(left=0.1,
                    ...
                    wspace=0.3, 
                    hspace=0.3)
fig.savefig(graphpath + r"fig23dparam.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
col = 0
row = 0
axes[row, col].axvspan(stimstart, stimend20min, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames20min, apical20minstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames20min, apical20minstimls[1], apical20minstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames20min, apical20minnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
axes[row, col].fill_between(frames20min, apical20minnonstimls[1], apical20minnonstimls[2], color='#4f81c2', alpha=.1)
axes[row, col].legend(loc = "lower right", fontsize = 7)
#axes[row, col].title('Cell apical area')
#axes[row, col].set_xlabel("Time (min)")
...
col = 2
row = 0
axes[row, col].axvspan(stimstart, stimendC450V, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(framesC450V, apicalC450Vstimls[0], c ='#60D394', label = "Stimulated \nC450V mutant", linewidth = 1)
...
row = 1
axes[row, col].axvspan(stimstart, stimend20min, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames20min, basal20minstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames20min, basal20minstimls[1], basal20minstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames20min, basal20minnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
axes[row, col].fill_between(frames20min, basal20minnonstimls[1], basal20minnonstimls[2], color='#4f81c2', alpha=.1)
axes[row, col].legend(loc = "lower right", fontsize = 7)
#plt.title('Cell basal area')
#axes[row, col].set_xlabel("Time (min)")
...
row = 2
axes[row, col].axvspan(stimstart, stimend20min, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames20min, length20minstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames20min, length20minstimls[1], length20minstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames20min, length20minnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
axes[row, col].fill_between(frames20min, length20minnonstimls[1], length20minnonstimls[2], color='#4f81c2', alpha=.1)
axes[row, col].legend(loc = "lower right", fontsize = 7)
#plt.title('Cell height (apical-basal)')
#axes[row, col].set_xlabel("Time (min)")
...
row = 3
axes[row, col].axvspan(stimstart, stimend20min, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames20min, vol20minstimls[0], c ='#dc756d', label = "Stimulated", linewidth = 1)
axes[row, col].fill_between(frames20min, vol20minstimls[1], vol20minstimls[2], color='#dc756d', alpha=.1)
axes[row, col].plot(frames20min, vol20minnonstimls[0], c ='#4f81c2', label = "Outer area", linewidth = 1)
axes[row, col].fill_between(frames20min, vol20minnonstimls[1], vol20minnonstimls[2], color='#4f81c2', alpha=.1)
axes[row, col].legend(loc = "lower right", fontsize = 7)
#plt.title('Cell volume')
axes[row, col].set_xlabel("Time (min)")
...
axes[row, col].spines['right'].set_visible(False)
axes[row, col].spines['top'].set_visible(False)
fig.savefig(graphpath + r"suppfigC450Vcomparison.pdf", bbox_inches='tight', transparent=True)
plt.show()  
...
ax = sns.swarmplot(data=data, size=2)
...
plt.savefig(graphpath  + r"apicalareaboxes.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
ax.plot([0,1],[top+0.04*top,top+0.04*top], c='k')
plt.savefig(graphpath  + r"basalareaboxes.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
ax.plot([0,1],[top+0.04*top,top+0.04*top], c='k')
plt.savefig(graphpath  + r"heightboxes.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
ax.plot([0,1],[top+0.04*top,top+0.04*top], c='k')
plt.savefig(graphpath  + r"volumeboxes.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
fig, axes = plt.subplots(figsize = (1.8,1.8))
axes.axvspan(stimstart,stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes.plot(frames2h, length2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes.plot(frames2h, lens, c ='#820263', label = "Predicted", linewidth = 1)
axes.legend(loc = "lower right", fontsize = 7)
#plt.title('Cell height (apical-basal)')
...
fig.savefig(graphpath + r"fig2predictors.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
row = 0
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, apical2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, aps, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
axes[row, col].set_ylabel("Apical area " + r"$(μm^{2})$")
...
axes[row, col].plot(frames2h, C450Vaps, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
axes[row, col].set_ylim(0,260)
axes[row, col].spines['right'].set_visible(False)
axes[row, col].spines['top'].set_visible(False)
...
row = 1
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, basal2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, bas, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell basal area')
#axes[row, col].set_xlabel("Time (min)")
axes[row, col].set_ylabel("Basal area " + r"$(μm^{2})$")
...
axes[row, col].plot(frames2h, C450Vbas, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell basal area')
#axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell basal area " + r"$(μm^{2})$")
...
row = 2
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, length2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, lens, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell height (apical-basal)')
#axes[row, col].set_xlabel("Time (min)")
axes[row, col].set_ylabel("Height " + r"$(μm)$")
...
axes[row, col].plot(frames2h, C450Vlens, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell height (apical-basal)')
#axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell length " + r"$(μm)$")
...
row = 3
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, vol2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, vols, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell volume')
axes[row, col].set_xlabel("Time (min)")
axes[row, col].set_ylabel("Volume (fL)")
...
axes[row, col].plot(frames2h, C450Vvols, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell volume')
axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell volume (fL)")
...
axes[row, col].spines['right'].set_visible(False)
axes[row, col].spines['top'].set_visible(False)
fig.savefig(graphpath + r"fig23dpredictors.pdf", bbox_inches='tight', transparent=True)
plt.show()
...
row = 0
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, relapical2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, relaps, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
...
axes[row, col].plot(frames2h, relC450Vaps, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
axes[row, col].set_ylim(0,1.3)
axes[row, col].spines['right'].set_visible(False)
axes[row, col].spines['top'].set_visible(False)
...
row = 1
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, relbasal2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, relbas, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell basal area')
#axes[row, col].set_xlabel("Time (min)")
...
axes[row, col].plot(frames2h, relC450Vbas, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell basal area')
#axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell basal area " + r"$(μm^{2})$")
...
row = 2
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, rellength2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, rellens, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell height (apical-basal)')
#axes[row, col].set_xlabel("Time (min)")
...
axes[row, col].plot(frames2h, relC450Vlens, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell height (apical-basal)')
#axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell length " + r"$(μm)$")
...
row = 3
axes[row, col].axvspan(stimstart, stimend2h, color='#a4c3f6', alpha = 0.2, fill = "True", lw= 0)
axes[row, col].plot(frames2h, relvol2hstimls[0], c ='#dc756d', label = "Measured", linewidth = 1)
axes[row, col].plot(frames2h, relvols, c ='#4f81c2', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell volume')
axes[row, col].set_xlabel("Time (min)")
...
axes[row, col].plot(frames2h, relC450Vvols, c ='#820263', label = "Predicted", linewidth = 1)
axes[row, col].legend(loc = "lower right", fontsize = 6)
#plt.title('Cell volume')
axes[row, col].set_xlabel("Time (min)")
#axes[row, col].set_ylabel("Cell volume (fL)")
...
axes[row, col].spines['right'].set_visible(False)
axes[row, col].spines['top'].set_visible(False)
fig.savefig(graphpath + r"fig23dpredictorsrel.pdf", bbox_inches='tight', transparent=True)
plt.show()
