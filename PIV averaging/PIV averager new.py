...
ax.plot([2*i for i in range(tps)], outervelmean, linewidth = 5, c='g', label= 'Outer area', alpha =0.8)
ax.plot([2*i for i in range(tps)], midvelmean, linewidth = 5, color='#4f81c2', label= 'Adjacent area', alpha =0.8)
ax.plot([2*i for i in range(tps)], invelmean, linewidth = 5, c='#dc756d', label= 'Stimulated area', alpha =0.8)
ax.set_ylabel('Radial velocity (um/min)')
ax.set_xlabel('Time (min)')
ax.legend(fontsize = 30)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
#plt.show()
plt.savefig(FolderToSaveGraphs + '/' + graphnames + 'ClassVectorsSpeeds.png', bbox_inches='tight')
...
for i in range(8, 68):
    ax.axvspan(i + 0.333, i + 0.917, color = '#a4c3f6', alpha = 0.3)
ax.plot([2*i for i in range(tps)], outersummean, linewidth = 5, c='g', label= 'Outer area', alpha = 0.8)
ax.plot([2*i for i in range(tps)], midsummean, linewidth = 5, color='#4f81c2', label= 'Adjacent area', alpha = 0.8)
ax.plot([2*i for i in range(tps)], insummean, linewidth = 5, color='#dc756d', label= 'Stimulated area', alpha = 0.8)
ax.set_ylabel('Radial displacement (um)')
ax.set_xlabel('Time (min)')
ax.legend(fontsize = 28, loc = "lower center")
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
#plt.show()
plt.savefig(FolderToSaveGraphs + '/' + graphnames + 'ClassVectorsDisp', bbox_inches='tight')
...
plt.axvspan(0, 24.98, color = 'gray', alpha = 0.3)
...
plt.axvspan(0, 24.98, color = '#78e3d8', alpha = 0.3)
...
#plt.show()
plt.savefig(FolderToSaveGraphs + '/' + graphnames + 'SpatialDistribselected.png', bbox_inches='tight')
