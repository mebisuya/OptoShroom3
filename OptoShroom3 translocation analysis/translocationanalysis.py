...
fig,([ax1, ax2], [ax3, ax4]) = plt.subplots(2,2,figsize = (34, 30), dpi=200)
ax1.axvspan(60, 120, color = '#a4c3f6', alpha = 0.3)
#set_title("Translocation evolution (n=18) ratio junction/cytoplasm signal")
ax1.plot(timelist, OptoShmeanJun, label = "OptoShroom3 (MDCK)", color = "#dc756d",  linewidth=5.0)
ax1.fill_between(timelist, OptoShsdupJun, OptoShsdlowJun, color='#dc756d', alpha=.1)
ax1.plot(timelist, c450vC2meanJun, label = "OptoShroom3 C450V mutant (MDCK)", color = "#60D394",  linewidth=5.0)
ax1.fill_between(timelist, c450vC2sdupJun,c450vC2sdlowJun , color='#60D394', alpha=.1)
ax1.plot(timelist, OptoChmeanJun, label = "GFP-NShroom3-iLID + SspB-mCherry (MDCK)", color = "#4f81c2",  linewidth=5.0)
...
ax2.axvspan(60, 120, color = '#a4c3f6', alpha = 0.3)
#set_title("Translocation evolution (n=18) ratio junction/cytoplasm signal")
ax2.plot(timelist, OptoShRatedmean, label = "OptoShroom3 (MDCK)", color = "#dc756d",  linewidth=5.0)
ax2.fill_between(timelist, OptoShRatedsdup,OptoShRatedsdlow , color='#dc756d', alpha=.1)
ax2.plot(timelist, c450vC2Ratedmean, label = "OptoShroom3 C450V mutant (MDCK)", color = "#60D394",  linewidth=5.0)
ax2.fill_between(timelist, c450vC2Ratedsdup,c450vC2Ratedsdlow , color='#60D394', alpha=.1)
ax2.plot(timelist, OptoChRatedmean, label = "GFP-NShroom3-iLID + SspB-mCherry (MDCK)", color = "#4f81c2",  linewidth=5.0)
...
ax3.axvspan(60, 120, color = '#a4c3f6', alpha = 0.3)
ax3.plot(timelist, EyecupmeanJun, label = "OptoShroom3 (Optic vesicle)", color = "#820263",  linewidth=5.0)
...
ax4.axvspan(60, 120, color = '#a4c3f6', alpha = 0.3)
ax4.plot(timelist, EyecupRatedmean, label = "OptoShroom3 (Optic vesicle)", color = "#820263",  linewidth=5.0)
...
fig.savefig(savefolder + r"//translocationSuppfigure.png", bbox_inches='tight')
plt.show()
