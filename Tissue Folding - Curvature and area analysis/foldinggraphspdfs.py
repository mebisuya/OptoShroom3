...
ax.plot(realtime, areasC, c="#4f81c2", label="Control", linewidth=1)
ax.fill_between(realtime, areasCplussd, areasCminussd, color='#4f81c2', alpha=.2)
ax.plot(realtime,areasI, c="#dc756d", label="Stimulated", linewidth=1)
...
plt.show()
fig.savefig(FolderToSave + "/" + d1+  'MeanAreasfig.pdf', bbox_inches='tight', transparent=True)
...
ax.plot(realtime, curvC, c="#4f81c2", label="Control", linewidth=1)
ax.fill_between(realtime, curvCplussd, curvCminussd, color='#4f81c2', alpha=.2)
ax.plot(realtime,curvI, c="#dc756d", label="Stimulated", linewidth=1)
...
ax.spines['top'].set_visible(False)
plt.show()
plt.savefig(FolderToSave + "/" + d1 + 'MeanCurvaturesMainfig.pdf', bbox_inches='tight', transparent=True)
...
plt.rcParams.update({'font.size': 7})
#Plotting controls
plt.figure(figsize = (7.3, 1.1))
for i in range(len(listofcurvC)):
    ax = plt.subplot(1,7,i+1)
    plt.plot(realtime, listofcurvC[i], c="#4f81c2", linewidth=2)
    ax.spines['right'].set_visible(False)
    ax.spines['top'].set_visible(False)
    plt.xlabel('Time (h)')
    if i == 0:
        plt.ylabel('Curvature '+ r'$ (μm^{-1})$')
    plt.ylim([-0.015,0.02])
#plt.show()
plt.tight_layout()
plt.savefig(FolderToSave + "/" + d1 + 'AllCurvaturesControl.pdf',bbox_inches='tight', transparent=True)

#Ploting stimulated
plt.figure(figsize = (7.3, 1.1))
for i in range(len(listofcurvC)):
    ax = plt.subplot(1,7,i+1)
    plt.plot(realtime, listofcurvI[i], c="#dc756d", linewidth=2)
    ax.spines['right'].set_visible(False)
    ax.spines['top'].set_visible(False)
    plt.xlabel('Time (h)')
    if i == 0:
    ...
    plt.ylim([-0.015,0.02])
plt.tight_layout()
plt.savefig(FolderToSave + "/" + d1 + 'AllCurvaturesStim.pdf',bbox_inches='tight', transparent=True)
...
for i in range(len(listofcurvCC450V)):
    ax = plt.subplot(1,7,i+1)
    plt.plot(realtime, listofcurvIC450V[i], c="#60D394", linewidth=1)
    ax.spines['right'].set_visible(False)
    ax.spines['top'].set_visible(False)
    plt.xlabel('Time (h)')
    if i == 0:
    ...
    plt.ylim([-0.015,0.02])
plt.tight_layout()
plt.savefig(FolderToSave + "/" + d1 + 'AllCurvaturesStimC450V.pdf',bbox_inches='tight', transparent=True)
...
fig,ax = plt.subplots(figsize = (2, 1.8))
#plt.title('Mean areas')
ax.plot(realtime,areasIC450V, c="#60D394", label="Stimulated C450V mutant", linewidth=1)
ax.fill_between(realtime, areasIplussdC450V, areasIminussdC450V, color='#60D394', alpha=.2)
ax.plot(realtime, areasC, c="#4f81c2", label="Non-stimulated", linewidth=1)
ax.fill_between(realtime, areasCplussd, areasCminussd, color='#4f81c2', alpha=.2)
ax.plot(realtime,areasI, c="#dc756d", label="Stimulated", linewidth=1)
ax.fill_between(realtime, areasIplussd, areasIminussd, color='#dc756d', alpha=.2)
ax.set_xlabel('Time (h)')
...
ax.spines['top'].set_visible(False)
#plt.show()
fig.savefig(FolderToSave + "/" + 'MeanAreasfigfull.pdf', bbox_inches='tight', transparent=True)
...
fig,ax = plt.subplots(figsize = (2, 1.8))
#plt.title('Mean curvatures Main axis')
ax.plot(realtime,curvIC450V, c="#60D394", label="Stimulated C450V mutant", linewidth=1)
ax.fill_between(realtime, curvIplussdC450V, curvIminussdC450V, color='#60D394', alpha=.2)
ax.plot(realtime, curvC, c="#4f81c2", label="Non-stimulated", linewidth=1)
ax.fill_between(realtime, curvCplussd, curvCminussd, color='#4f81c2', alpha=.2)
ax.plot(realtime,curvI, c="#dc756d", label="Stimulated", linewidth=1)
ax.fill_between(realtime, curvIplussd, curvIminussd, color='#dc756d', alpha=.2)
ax.set_xlabel('Time (h)')
...
ax.spines['top'].set_visible(False)
plt.show()
fig.savefig(FolderToSave + "/" + 'MeanCurvaturesMainfigfull.pdf', bbox_inches='tight', transparent=True)
