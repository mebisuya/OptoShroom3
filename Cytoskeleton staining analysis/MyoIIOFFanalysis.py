...
path = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\cytoskeleton analysis\MyoIIb OFF'
graphpath = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\cytoskeleton analysis\graphs'
datapath = r'\\ebisuya.embl.es\ebisuya\Guillermo\Optoshroom3 paper\Python scripts and raw data\cytoskeleton analysis\MyoIIbOFFdata'
